...
export default function Navbar({ navigationData, activeSection, callToAction }: NavbarProps) {
    ...
    return (
        <div>
            <header className="bg-background/80 border-b border-border backdrop-blur-sm fixed w-full z-50 transition-all duration-300">
                <div className="max-w-7xl mx-auto w-full px-4 py-2 sm:px-6 lg:px-8 flex items-center">
                    <nav className={
                        cn("flex items-center w-full transition-all duration-300", sticky ? "py-0" : "py-2")
                    }>
